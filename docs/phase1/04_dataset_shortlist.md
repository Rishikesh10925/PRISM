...
| D5 | Pothole Object Detection Dataset (Roboflow public dataset) | ~665 images (mirrors D2 source) | Images + multiple export formats incl. YOLOv8 | pothole | Public Domain (per Roboflow public-dataset listing) | [Roboflow](https://public.roboflow.com/object-detection/pothole) |
